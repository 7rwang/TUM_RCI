...
% generate random 3D points with min 3m distance to camera
P=[randn(1,30)*2;randn(1,30)*2;rand(1,30)*3+3;ones(1,30)];
...
% check the squares of eigenvalues in the diagonal of S
S
